...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.biometrics.fingerprint@2.1-service.leeco_zl1
LOCAL_INIT_RC := android.hardware.biometrics.fingerprint@2.1-service.leeco_zl1.rc
